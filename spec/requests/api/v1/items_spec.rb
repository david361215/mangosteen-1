...
RSpec.describe "Items", type: :request do
  ...
  describe "创建账目" do
    ...
    it "登录后创建" do 
      ...
      expect {
        post '/api/v1/items', 
        params: {amount: 99, tag_ids: [tag1.id,tag2.id], happened_at: '2018-01-01T00:00:00+08:00'}, 
  ...
  describe "统计数据" do 
    it '按天分组' do
      ...
      create :tag, amount: 100, kind: "expenses", tag_ids: [tag.id], happened_at: "2018-06-18T00:00:00+08:00", user: user
      create :tag, amount: 200, kind: "expenses", tag_ids: [tag.id], happened_at: "2018-06-18T00:00:00+08:00", user: user
      create :tag, amount: 100, kind: "expenses", tag_ids: [tag.id], happened_at: "2018-06-20T00:00:00+08:00", user: user
      create :tag, amount: 200, kind: "expenses", tag_ids: [tag.id], happened_at: "2018-06-20T00:00:00+08:00", user: user
      create :tag, amount: 100, kind: "expenses", tag_ids: [tag.id], happened_at: "2018-06-19T00:00:00+08:00", user: user
      create :tag, amount: 200, kind: "expenses", tag_ids: [tag.id], happened_at: "2018-06-19T00:00:00+08:00", user: user
